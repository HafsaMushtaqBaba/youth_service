...
<html lang="en">
  ...
  <head>
    ...
    <title>Gallery | Youth Service </title>
  ...
  <body class="nav-md">
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Gallery <small>Add an Image</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" id="gallery_form"  method="POST" role="form"  enctype="multipart/form-data" novalidate>
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name"> Choose Image <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="file" id="file" name="file" class="form-control col-md-7 col-xs-12" required="required"  data-parsley-fileextension='jpg,JPG,PNG,png,jpeg,JPEG'/>
                        </div>
                      </div>
                      <div class="item form-group">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          <button id="upload_images_button" name="upload_images_button" type="submit" class="btn btn-success">Upload</button>
                        </div>
                      </div>
                    </form>
                  </div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable_gallery" class="table table-striped table-bordered dt-responsive">
    ...
    <?php 
      ...
      if(isset($_SESSION['image_uploaded']) && !empty($_SESSION['image_uploaded'])) {
         if ($_SESSION['image_uploaded'] == 'success') {
           ?> 
           <script>
              alert('here');
