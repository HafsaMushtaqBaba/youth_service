              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" id="district_form"  method="POST" novalidate>
                      </p>

                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="district_name"> District Name <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="district_name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"  name="district_name" placeholder="e.g Srinagar" required="required" type="text">
                        </div>
                      </div>
                      <div class="ln_solid"></div>
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          <button id="add_district" type="submit" class="btn btn-success">Submit</button>
                        </div>
                      </div>
                    </form>
                  </div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable_district" class="table table-striped table-bordered dt-responsive">
         ...
         if ($_SESSION['added'] == 'success') {
           ...
           <script>
              ...
              $(document).ready(function () {
                  new PNotify({
                        title: 'Status',
                        text: 'District Added Sucessfully!',
                        type: 'success',
                        styling: 'bootstrap3'
                    });
              });      
