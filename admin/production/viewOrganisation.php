          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Employees <small>List Of All Employees,Districts,Zones</small></h3>
              </div>
            </div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table  id="datatable_organisation" class="table table-striped table-bordered dt-responsive">
